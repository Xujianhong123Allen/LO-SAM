// Generated by gencpp from file LO_SAM/cloud_info.msg
// DO NOT EDIT!


#ifndef LO_SAM_MESSAGE_CLOUD_INFO_H
#define LO_SAM_MESSAGE_CLOUD_INFO_H
...
struct cloud_info_
{
  ...
  typedef boost::shared_ptr< ::LO_SAM::cloud_info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::LO_SAM::cloud_info_<ContainerAllocator> const> ConstPtr;

}; // struct cloud_info_

typedef ::LO_SAM::cloud_info_<std::allocator<void> > cloud_info;

typedef boost::shared_ptr< ::LO_SAM::cloud_info > cloud_infoPtr;
typedef boost::shared_ptr< ::LO_SAM::cloud_info const> cloud_infoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::LO_SAM::cloud_info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::LO_SAM::cloud_info_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::LO_SAM::cloud_info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::LO_SAM::cloud_info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::LO_SAM::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::LO_SAM::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::LO_SAM::cloud_info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::LO_SAM::cloud_info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::LO_SAM::cloud_info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::LO_SAM::cloud_info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x50b728f6fcea6789ULL;
  static const uint64_t static_value2 = 0xaf5feea0b14f80feULL;
};

template<class ContainerAllocator>
struct DataType< ::LO_SAM::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "LO_SAM/cloud_info";
  }
...
template<class ContainerAllocator>
struct Definition< ::LO_SAM::cloud_info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Cloud Info\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::LO_SAM::cloud_info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::LO_SAM::cloud_info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::LO_SAM::cloud_info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LO_SAM_MESSAGE_CLOUD_INFO_H